...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Thứ hai là Monday ";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Thứ ba là Tuesday';
document.querySelector('.Description .modal-body').innerHTML = 'Người yêu em là Anhday <i class="fas fa-heart"></i> ';
